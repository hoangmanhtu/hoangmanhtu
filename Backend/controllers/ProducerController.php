...
class ProducerController extends Controller
{
    public function index()
    {
        ...
        $this->content=$this->render('Backend/views/producers/index.php',$arr_output);
    ...
    public function create()
    {
        if(isset($_POST["submit"])) {
            ...
            if (empty($this->error)) {
                ...
                header("location:index.php?area=backend&controller=producer&action=index");
                exit();
            }
        }
        $this->content=$this->render("Backend/views/producers/create.php");
        require_once "Backend/views/layouts/main.php";
    }
    ...
    public function detail()
    {
        if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
            ...
            header('Location: index.php?controller=producer&action=index');
            exit();
        }
        $id = $_GET['id'];
        $producer_model=new Producer();
        $producer=$producer_model->getById($id);
        $this->content=$this->render("backend/views/producers/detail.php",["producer"=>$producer]);
        require_once 'backend/views/layouts/main.php';
    }
//        update danh mục
    public function update()
    {
        ...
        $this->content=$this->render("Backend/views/producers/update.php",["producer" => $producer]);
        require_once "Backend/views/layouts/main.php";
    }
//        xóa danh mục
