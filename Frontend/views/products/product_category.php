                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <?php   if($page > 1):
                                $prev_page=$page-1;
                                ?>
                                <li class="page-item previous-btn"><a class="page-link" href="<?php echo $category_link; ?>/<?php echo $prev_page;?>">Previous</a></li>
                            <?php endif; ?>
                            <?php for($i=1;$i <= $numPage;$i++):
                                if($i != $page):
                                    ?>
                                    <li class="page-item"><a class="page-link" href="<?php echo $category_link; ?>/<?php echo $i ;?>"><?php echo $i; ?></a></li>
                                <?php else: ?>
                                    <li class="page-item active"><a class="page-link" href="<?php echo $category_link; ?>/<?php echo $i ;?>"><?php echo $i; ?></a></li>
                                <?php endif;
                            endfor;
                            ?>
                            <?php   if($page < $numPage ):
                                $next_page=$page + 1;
                                ?>
                                <li class="page-item next-btn"><a class="page-link" href="<?php echo $category_link; ?>/<?php echo $next_page ;?>">Next</a></li>
                            <?php endif;?>
                        </ul>
                    </nav>
                </div>
