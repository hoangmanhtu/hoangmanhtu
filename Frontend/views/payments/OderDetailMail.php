...
<div class="container">
    ...
    <p>Để thanh toán đơn hàng , bạn hãy chuyển khoản theo thông tin sau :</p>
    <h4>Hoàng Mạnh Tú (Ngân hàng MB Bank-Chi nhánh Thanh Xuân)</h4>
...
<div style="margin: auto;width: 600px">
    ...
    <table style=" border-collapse: collapse;" border="1px solid #dadada;">
        ...
        <tr>
            ...
            <td  style="text-align: center">
                <?php echo $_SESSION["order"]["mobile"] ?>
            </td>
            <td  style="text-align: center">
